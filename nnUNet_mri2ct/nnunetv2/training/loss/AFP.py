    ...
    def __init__(self, net: str = "", layers=[], mae_weight=0.0, normalize_before_L1=False):
        ...
        model_params = {
            ...
            "TotalSeg117": { #patch_size : [128 128 128], 0.6mm, 117 labels kept
                "weights_path": "/path/to/.totalsegmentator/nnunet/results/Dataset298_TotalSegmentator_total_6mm_1559subj/nnUNetTrainer_4000epochs_NoMirroring__nnUNetPlans__3d_fullres/fold_0/checkpoint_final.pth",
