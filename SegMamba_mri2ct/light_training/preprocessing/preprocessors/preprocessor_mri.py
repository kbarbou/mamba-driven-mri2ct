...
class MultiModalityPreprocessor(DefaultPreprocessor):
    ...
    def read_data(self, case_name):
        ...
        if self.seg_filename != "":
            ...
            seg_arr = seg_arr[None] # Add extra axis (i.e. unsqueeze)
        ...
        if self.mask_filename is not None:
            ...
            print(f"[DEBUG] Mask for {case_name.split(".")[0]} read successfully in read_data function of MultiModalityPreprocessor class")    
        ...
        return data, seg_arr, properties, mask_arr
    ...
    def run(self, 
        ...
        # test_run before spinning up a large multiprocessing pool
